#this file is meant to generate spelling rules from a list of identified name tokens
...
def run(corpus, allrules, names, maxrules):
    ...
    resultlist = sorted(list(rules.rules), key=lambda x: x.strength, reverse=True)
